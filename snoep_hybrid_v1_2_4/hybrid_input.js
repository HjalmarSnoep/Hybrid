...
function _hybridStandardiseButtonClick(e)
{
	...
	_hybridRegisterMouse(e); // get the coordinates on any click!
...
function _hybridMakeButton(box, label, cb, cb_over)
{
  ...
  // keep the callback as an attribute, just like label.. duhh!!
  ...
  // get function names and save the callback functions in the button!:
   _hybridAddCallbackAsAttr(box,"cb",cb);
   if(typeof(cb_over)!="undefined")_hybridAddCallbackAsAttr(box,"cbo",cb_over);
