...
Hybrid.physics.createWorld=_hybridcreateBox2DWorld
 function _hybridcreateBox2DWorld(dx,dy)
 {
	if(typeof(dx)=="undefined") dx=0;
	if(typeof(dy)=="undefined") dy=15;// standard grav
		var w = new b2World(
...
{
	Hybrid.debugmessage("connecting world" +w+" to canvas"+hbc+" testing with 100x100");
	//setup debug draw
